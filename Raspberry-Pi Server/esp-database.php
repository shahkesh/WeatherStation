<?php
  ...
  function getLastReadings() {
    ...
    $sql = "SELECT id, sensor, location, value1, value2, reading_time FROM SensorData WHERE value1 IS NOT NULL order by reading_time desc limit 1" ;
    if ($result = $conn->query($sql)) {
...
function getLastReadingsLIGHT() {
    ...
    $sql = "SELECT value3, reading_time FROM SensorData WHERE value3 IS NOT NULL order by reading_time desc limit 1" ;
    if ($result = $conn->query($sql)) {
      return $result->fetch_assoc();
    }
    else {
